...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('CREATE INDEX title_icontains_index ON publications_publication (upper(title) varchar_pattern_ops);')
        db.execute('CREATE INDEX authors_icontains_index ON publications_publication (upper(authors) varchar_pattern_ops);')
    ...
    models = {
        ...
        'publications.publication': {
            ...
            'state': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '5', 'null': 'True', 'blank': 'True'}),
