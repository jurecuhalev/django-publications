...
class Publication(models.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self._produce_author_lists_bitex()

    # def _produce_author_lists_bitex(self):
    #     from publications.bibtex import render_author_fields
    #     title, names = render_author_fields(author=self.authors, title=self.title)
    #
    #     self.authors_bibtext = self.authors
    #     self.authors_list = names
